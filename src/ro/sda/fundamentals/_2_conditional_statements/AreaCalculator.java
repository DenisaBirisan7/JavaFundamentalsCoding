...
public class AreaCalculator {
    public static void main(String[] args) {
        ...
        System.out.println(area(-5.75));

        System.out.println(area(10.2,3.7));
        System.out.println(area(-2,3.7));
 //       double result =
    }
    ...
    //method overloading is when we have a method with the same name but different parameters (different number of param OR different types or both)
