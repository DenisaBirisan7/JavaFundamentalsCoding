package ro.sda.fundamentals._6_classes._part_4;
...
public class ComplexNumber {
    ...
    //when a method has different type of the parameters and/or different number of parameters
    //but it is named the same, then we call it method OVERLOADING
